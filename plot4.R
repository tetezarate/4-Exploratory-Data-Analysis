...
plot(reduced_database$Time, reduced_database$Global_active_power, type = "l")
plot(reduced_database$Time, reduced_database$Voltage, type = "l")
...
plot(reduced_database$Time, reduced_database$Global_reactive_power, type = "l")
